...
class PackagesModel {
  ...
  factory PackagesModel.fromJson(Map<String, dynamic> json) => PackagesModel(
    data: json["data"] == null ? [] : List<PackagesModelData>.from(json["data"]!.map((x) => PackagesModelData.fromJson(x))),
    msg: json["msg"],
    status: json["status"],
  );
...
class PackagesModelData {
  ...
  factory PackagesModelData.fromJson(Map<String, dynamic> json) => PackagesModelData(
    id: json["id"],
    title: json["title"],
