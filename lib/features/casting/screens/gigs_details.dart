...
class _GigsDetailsScreenState extends State<GigsDetailsScreen> {
  @override
  void initState() {
    context.read<CastingCubit>().getDetailsGigs(id: widget.id?.id ?? '');
    super.initState();
  }
