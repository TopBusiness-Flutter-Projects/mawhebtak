                                        ...
                                        if (selectedIndex == 0) Column(
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Text("top_talent".tr(),style: TextStyle(color: AppColors.blackLite,fontSize: 16.sp),),
                                            ),
                                          ...
                                          children: [
                                            Padding(
                                              padding:  EdgeInsets.symmetric(horizontal: 20.w,vertical: 10.h),
                                              child: Text("gigs_list".tr(),style: TextStyle(color: AppColors.blackLite,fontSize: 16.sp),),
                                            ),
