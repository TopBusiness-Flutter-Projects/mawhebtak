           ...
           children: [
             ...
             Expanded(
               child: GestureDetector(
                 ...
                 child: Container(
                   decoration: BoxDecoration(
                     color: cubit.selectedIndex == 0 ? Colors.lightBlue : Colors.transparent,
                     borderRadius: BorderRadius.circular(8.r),
                   ),
                   ...
                   child: Padding(
                     ...
                     child: Text(
                       'events_details'.tr(),
                       style: getRegularStyle(color: cubit.selectedIndex == 0 ? Colors.white : Colors.grey, )
             ...
             Expanded(
               child: GestureDetector(
                ...
                cubit.changeToggle(1);
                 ...
                 child: Container(
                   decoration: BoxDecoration(
                     color:cubit. selectedIndex == 1 ? Colors.lightBlue : Colors.transparent,
                   ...
                   child: Padding(
                     ...
                     child: Text(
                       'enrolled_users'.tr(),
                                         style: getRegularStyle(color: cubit.selectedIndex == 1 ? Colors.white : Colors.grey, )
